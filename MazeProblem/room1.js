  ...
  //  var map = this.make.tilemap({key:'world'});
   var map = this.make.tilemap({key:'level2'});
    ...
    this.player.setCollideWorldBounds(true); // don't go out of the this.map
      ...
      this.npc2= this.physics.add.sprite(104  ,1105,"npc2").setScale(1.6);
      this.npc3= this.physics.add.sprite(1050  ,1005,"npc3").setScale(1.6);
      this.npc4= this.physics.add.sprite(2200  ,1905,"npc4").setScale(1.6);
